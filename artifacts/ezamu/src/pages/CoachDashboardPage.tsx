            ...
            <div className="col-span-1 md:col-span-2">
              <Card className="shadow-sm border-none">
                <CardHeader className="border-b bg-slate-50/50 flex flex-row items-center justify-between pb-4">
                  <div>
                    <CardTitle className="text-xl font-serif text-[#121c34]">
                      Upcoming Sessions
                    </CardTitle>
                  ...
                  <Link href="/my-appointments">
                    <Button
                      variant="outline"
                      size="sm"
                      className="text-[#3131d8] border-[#3131d8]/30 hover:bg-[#3131d8]/5"
                    >
                        ...
                        >
                          <div className="w-12 h-12 rounded-xl bg-[#3131d8]/10 flex flex-col items-center justify-center flex-shrink-0 text-[#3131d8]">
                            <span className="text-xs font-bold">
                              {format(new Date(appt.scheduledAt), "MMM").toUpperCase()}
                            </span>
            ...
            <div className="col-span-1">
              <Card className="shadow-sm border-none">
                <CardHeader className="border-b bg-slate-50/50 pb-4">
                  <CardTitle className="text-lg font-serif text-[#121c34]">
                    Your Students
                  </CardTitle>
                  <p className="text-xs text-muted-foreground mt-1">
                    Open a student profile to review their information.
                  </p>
                </CardHeader>
                  ...
                  {recentStudents.length > 0 ? (
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-muted-foreground mt-0.5">
                                {student.nextAppointmentAt
                                  ...
                                  : `${student.totalAppointments} session${
                                      student.totalAppointments !== 1 ? "s" : ""
                                    }`}
                              </p>
                            </div>
                    ...
                    <div className="p-6 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        No students yet. Students will appear here once you have booked sessions.
                      </p>
                    </div>
                  )}
                </CardContent>
